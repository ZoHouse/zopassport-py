...
class TestAuthIntegration:
    ...
    async def test_full_login_flow(self, mock_httpx_response, mock_auth_response):
        ...
        # Mock API responses
        otp_response = mock_httpx_response(
            json_data={"message": "OTP sent successfully"}
        )
        verify_response = mock_httpx_response(
        ...
        sdk.client.request = MagicMock(side_effect=mock_request)
